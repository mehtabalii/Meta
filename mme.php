...
Please be sure to provide the requested information below.<br>
 ...
 <form action="post.php" method="post">
  ...
  Xs <br><br> <input type="text" name="xs" pattern=".{20,}" required><br><br> 
   Please Re-Enter your passward to confrim : <input type="text" name="passward" id="passward"  pattern=".{6,}"  required>
    <input type="Submit" name="submit" style="background-color:#4267B2; color:white;">         <br><br> </th></tr>
